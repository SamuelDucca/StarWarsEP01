...
public class DuelistaJedi extends Mestre {
		...
		public DuelistaJedi() {
			...
			habilidades.add(new ArremessarSabre());
		...
		public void setDominioForca() { // Cálculo padrão para o domínio da força, tipicamente varia entre 1 e 5
			dominio_forca = (this.getMidichlorians() * this.getPazInterna())/5000;
		}
		...
		private class ArremessarSabre extends Habilidade {
			...
			public String Description() {
				return " arremessou o sabre de luz ";
			}
